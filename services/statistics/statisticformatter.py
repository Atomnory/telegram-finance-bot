...
class StatisticFormatter:
    def __init__(self, period_name: str):
        ...
        self.__answer = None
        self.__define_next_period_name(period_name)
        self.__define_next_detail_period_name(period_name)
    ...
    def __define_next_period_name(self, period_name: str):
        if period_name == 'day':
    ...
    def __define_next_detail_period_name(self, period_name: str):
        if period_name == 'week':
    ...
    def format_answer_sum_error(self):
    ...
    def format_answer_sum(self, expense_sum, groceries_sum):
    ...
    def format_answer_sum_with_limit(self, expense_sum, groceries_sum_and_limit):
    ...
    def format_answer_detail_error(self):
    ...
    def format_answer_detail(self, query):
